...
from availability_evaluation import calculate_availability
import pandas as pd
import time
...
def process_pair(pair, G, A_dic):
    ...
    print(f"Soruce: {source_node}, Target: {target_node}")
...
if __name__ == "__main__":
    ...
    result, combined_results = calculate_availability(G, "Houston", "Indianapolis", A_dic)
    print(result)
    # simulation_times = []
